...
public class DoubleDoorModule implements Module, Listener {
    ...
    /**
     * Same priority as the former door handling inside {@link BlockDecorationModule}: runs after
     * default door toggling while still allowing sneak+item decoration clicks to bail early.
     */
